...
function initScene() {
    ...
    loader2.load('assets/man_player.glb', function (glb) {
        ...
        gui.add(man_player.scale, 'z', 60, 100, 0.01).name('Person Mass');
    ...
    loader3.load('assets/parachute_gta_san_andreas.glb', function (glb) {
        ...
        parachute_gta_san_andreas.translateZ(-85);
        parachute_gta_san_andreas.translateX(370);

        scene.add(parachute_gta_san_andreas);
        gui.add(parachute_gta_san_andreas.scale, 'z', 40, 100, 0.01).name('Parachute Mass');// ÷20
    ...
    gui.add(height, 'y', -1000, 4500, 1).onChange(function setHeight(value) {
        heights.forEach(w => {
            w.position.y = value;
        });
